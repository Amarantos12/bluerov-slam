...
"""autogenerated by genpy from kvh_gyro/gyro.msg. Do not edit."""
import codecs
import sys
...
class gyro(genpy.Message):
  _md5sum = "7bf4a7f82fe96d9124091847a68d6212"
  _type = "kvh_gyro/gyro"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.delta))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.delta = s.unpack(str[start:end])
      return self
