...
(cl:defmethod cl:initialize-instance :after ((m <OculusFire>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'OculusFire)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sonar_denoise-msg:<OculusFire> is deprecated: use sonar_denoise-msg:OculusFire instead.")))
...
(cl:defmethod mode-val ((m <OculusFire>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sonar_denoise-msg:mode-val is deprecated.  Use sonar_denoise-msg:mode instead.")
  (mode m))

(cl:ensure-generic-function 'gamma-val :lambda-list '(m))
(cl:defmethod gamma-val ((m <OculusFire>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sonar_denoise-msg:gamma-val is deprecated.  Use sonar_denoise-msg:gamma instead.")
  (gamma m))

(cl:ensure-generic-function 'flags-val :lambda-list '(m))
(cl:defmethod flags-val ((m <OculusFire>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sonar_denoise-msg:flags-val is deprecated.  Use sonar_denoise-msg:flags instead.")
  (flags m))

(cl:ensure-generic-function 'range-val :lambda-list '(m))
(cl:defmethod range-val ((m <OculusFire>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sonar_denoise-msg:range-val is deprecated.  Use sonar_denoise-msg:range instead.")
  (range m))

(cl:ensure-generic-function 'gain-val :lambda-list '(m))
(cl:defmethod gain-val ((m <OculusFire>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sonar_denoise-msg:gain-val is deprecated.  Use sonar_denoise-msg:gain instead.")
  (gain m))

(cl:ensure-generic-function 'speed_of_sound-val :lambda-list '(m))
(cl:defmethod speed_of_sound-val ((m <OculusFire>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sonar_denoise-msg:speed_of_sound-val is deprecated.  Use sonar_denoise-msg:speed_of_sound instead.")
  (speed_of_sound m))

(cl:ensure-generic-function 'salinity-val :lambda-list '(m))
(cl:defmethod salinity-val ((m <OculusFire>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sonar_denoise-msg:salinity-val is deprecated.  Use sonar_denoise-msg:salinity instead.")
  (salinity m))
