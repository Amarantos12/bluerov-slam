...
(cl:in-package sonar_denoise-msg)
...
(cl:defclass <OculusPingUncompressed> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (fire_msg
    :reader fire_msg
    :initarg :fire_msg
    :type sonar_denoise-msg:OculusFire
    :initform (cl:make-instance 'sonar_denoise-msg:OculusFire))
   (ping_id
    :reader ping_id
    :initarg :ping_id
    :type cl:integer
...
(cl:defmethod cl:initialize-instance :after ((m <OculusPingUncompressed>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'OculusPingUncompressed)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sonar_denoise-msg:<OculusPingUncompressed> is deprecated: use sonar_denoise-msg:OculusPingUncompressed instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <OculusPingUncompressed>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sonar_denoise-msg:header-val is deprecated.  Use sonar_denoise-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'fire_msg-val :lambda-list '(m))
(cl:defmethod fire_msg-val ((m <OculusPingUncompressed>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sonar_denoise-msg:fire_msg-val is deprecated.  Use sonar_denoise-msg:fire_msg instead.")
  (fire_msg m))

(cl:ensure-generic-function 'ping_id-val :lambda-list '(m))
(cl:defmethod ping_id-val ((m <OculusPingUncompressed>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sonar_denoise-msg:ping_id-val is deprecated.  Use sonar_denoise-msg:ping_id instead.")
  (ping_id m))

(cl:ensure-generic-function 'part_number-val :lambda-list '(m))
(cl:defmethod part_number-val ((m <OculusPingUncompressed>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sonar_denoise-msg:part_number-val is deprecated.  Use sonar_denoise-msg:part_number instead.")
  (part_number m))

(cl:ensure-generic-function 'start_time-val :lambda-list '(m))
(cl:defmethod start_time-val ((m <OculusPingUncompressed>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sonar_denoise-msg:start_time-val is deprecated.  Use sonar_denoise-msg:start_time instead.")
  (start_time m))

(cl:ensure-generic-function 'bearings-val :lambda-list '(m))
(cl:defmethod bearings-val ((m <OculusPingUncompressed>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sonar_denoise-msg:bearings-val is deprecated.  Use sonar_denoise-msg:bearings instead.")
  (bearings m))

(cl:ensure-generic-function 'range_resolution-val :lambda-list '(m))
(cl:defmethod range_resolution-val ((m <OculusPingUncompressed>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sonar_denoise-msg:range_resolution-val is deprecated.  Use sonar_denoise-msg:range_resolution instead.")
  (range_resolution m))

(cl:ensure-generic-function 'num_ranges-val :lambda-list '(m))
(cl:defmethod num_ranges-val ((m <OculusPingUncompressed>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sonar_denoise-msg:num_ranges-val is deprecated.  Use sonar_denoise-msg:num_ranges instead.")
  (num_ranges m))

(cl:ensure-generic-function 'num_beams-val :lambda-list '(m))
(cl:defmethod num_beams-val ((m <OculusPingUncompressed>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sonar_denoise-msg:num_beams-val is deprecated.  Use sonar_denoise-msg:num_beams instead.")
  (num_beams m))

(cl:ensure-generic-function 'ping-val :lambda-list '(m))
(cl:defmethod ping-val ((m <OculusPingUncompressed>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sonar_denoise-msg:ping-val is deprecated.  Use sonar_denoise-msg:ping instead.")
  (ping m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<OculusPingUncompressed>)))
  ...
  "sonar_denoise/OculusPingUncompressed")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'OculusPingUncompressed)))
  "Returns string type for a message object of type 'OculusPingUncompressed"
  "sonar_denoise/OculusPingUncompressed")
